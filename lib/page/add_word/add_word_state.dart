...
class AddWordState extends Equatable {
  AddWordState({
    ...
    this.pronunciationStatus = LOADSTATUS.INITAL,
    this.pronunciationAutoGenerated = false,
  });
  ...
  final LOADSTATUS pronunciationStatus;
  final bool pronunciationAutoGenerated;
  // ─── Helper ───────────────────────────────────────────────
  ...
  AddWordState copyWith({
    ...
    LOADSTATUS? pronunciationStatus,
    bool? pronunciationAutoGenerated,
    bool clearPronunciationAuto = false,
  }) {
    return AddWordState(
      ...
      pronunciationStatus: pronunciationStatus ?? this.pronunciationStatus,
      pronunciationAutoGenerated: clearPronunciationAuto ? false : (pronunciationAutoGenerated ?? this.pronunciationAutoGenerated),
    );
  }
